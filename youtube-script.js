...
async function init() {
    ...
    const config = {
        ...
        'controlPanelElements': ['play_pause', 'mute', 'volume', 'time_and_duration', 'spacer', 'captions', 'overflow_menu', 'fullscreen'],
        'overflowMenuButtons': ['picture_in_picture', 'language', 'quality', 'playback_rate']
    }
    ui.configure(config);
